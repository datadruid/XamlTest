...
extern void *mono_aot_module_XamlTest_iOS_info;
...
extern void *mono_aot_module_DewXamarinLocalization_info;
extern void *mono_aot_module_DewTypes_info;
extern void *mono_aot_module_Newtonsoft_Json_info;
extern void *mono_aot_module_Microsoft_CSharp_info;
extern void *mono_aot_module_DewStrings_info;
extern void *mono_aot_module_Xamarin_Forms_Maps_iOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_XamlTest_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_DewXamarinLocalization_info);
	mono_aot_register_module (mono_aot_module_DewTypes_info);
	mono_aot_register_module (mono_aot_module_Newtonsoft_Json_info);
	mono_aot_register_module (mono_aot_module_Microsoft_CSharp_info);
	mono_aot_register_module (mono_aot_module_DewStrings_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "XamlTest.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
